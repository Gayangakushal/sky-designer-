    ...
    <div className="site-container">
      <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#030713] px-7 py-14 text-center text-white shadow-[0_28px_80px_rgba(3,7,19,.24)] sm:px-12 sm:py-20">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <button onClick={onBookCall} className="mt-9 inline-flex min-h-14 items-center justify-center gap-3 rounded-xl bg-white px-7 text-sm font-extrabold text-slate-950 transition hover:-translate-y-1 hover:shadow-xl">Start a Project <ArrowRight size={18} /></button>
        </div>
      </motion.div>
    </div>
  </section>
