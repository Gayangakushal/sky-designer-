  ...
  return (
    <section id="team" className="py-24 relative">
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-sky-400 text-sm font-medium tracking-widest uppercase mb-3">The Experts</p>
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-white">Meet Our Team</h2>
        </motion.div>
