...
const categories = ["Facebook Ads", "Instagram Ads", "TikTok Ads"];
...
const facebookStandardPackages: PackageOption[] = [
  {
    id: "fb-std-1",
    title: "2,500 LKR Package (Max 5 days)",
    price: "2,500 LKR",
    duration: "Max 5 days",
    plan: "Standard",
    visible: true,
  ...
  {
    id: "fb-std-2",
    title: "3,800 LKR Package (Max 7 days)",
    price: "3,800 LKR",
    duration: "Max 7 days",
    plan: "Standard",
    visible: true,
  ...
  {
    id: "fb-std-3",
    title: "5,000 LKR Package (Max 10 days)",
    price: "5,000 LKR",
  ...
  {
    id: "fb-std-4",
    title: "6,800 LKR Package (Max 15 days) - Recommended",
    price: "6,800 LKR",
  ...
  {
    id: "fb-std-5",
    title: "8,500 LKR Package (Max 20 days) - Recommended",
    price: "8,500 LKR",
  ...
  {
    id: "fb-std-6",
    title: "10,000 LKR Package (Max 25 days) - Best Recommended",
    price: "10,000 LKR",
  ...
  {
    id: "fb-std-7",
    title: "11,500 LKR Package (Max 30 days) - Best Recommended",
    price: "11,500 LKR",
...
const facebookPremiumPackages: PackageOption[] = [
  {
    id: "fb-prem-1",
    title: "6,800 LKR Package (5 Days)",
    price: "6,800 LKR",
    duration: "5 Days",
    plan: "Premium",
    visible: true,
  ...
  {
    id: "fb-prem-2",
    title: "8,800 LKR Package (7 Days)",
    price: "8,800 LKR",
    duration: "7 Days",
    plan: "Premium",
    visible: true,
  ...
  {
    id: "fb-prem-3",
    title: "10,000 LKR Package (5/7 Days)",
    price: "10,000 LKR",
    duration: "5/7 Days",
    plan: "Premium",
    visible: true,
  ...
  {
    id: "fb-prem-4",
    title: "11,500 LKR Package (5/7 Days) - Recommended",
    price: "11,500 LKR",
    duration: "5/7 Days",
    plan: "Premium",
    visible: true,
  ...
  {
    id: "fb-prem-5",
    title: "13,500 LKR Package (5/7 Days) - Recommended",
    price: "13,500 LKR",
    duration: "5/7 Days",
    plan: "Premium",
    visible: true,
  ...
  {
    id: "fb-prem-6",
    title: "15,500 LKR Package (5/7 Days) - Best Recommended",
    price: "15,500 LKR",
    duration: "5/7 Days",
    plan: "Premium",
    visible: true,
...
const facebookPlatinumPackages: PackageOption[] = [
  {
    id: "fb-plt-1",
    title: "15,500 LKR Package (5/7 Days)",
    price: "15,000 LKR",
    duration: "5/7 Days",
    plan: "Platinum",
    visible: true,
  ...
  {
    id: "fb-plt-2",
    title: "20,000 LKR Package (5/7 Days)",
    price: "20,000 LKR",
    duration: "5/7 Days",
    plan: "Platinum",
    visible: true,
  ...
  {
    id: "fb-plt-3",
    title: "25,500 LKR Package (5/7 Days) - Recommended",
    price: "25,500 LKR",
    duration: "5/7 Days",
    plan: "Platinum",
    visible: true,
  ...
  {
    id: "fb-plt-4",
    title: "35,000 LKR Package (5/7 Days) - Recommended",
    price: "35,000 LKR",
    duration: "5/7 Days",
    plan: "Platinum",
    visible: true,
  ...
  {
    id: "fb-plt-5",
    title: "45,000 LKR Package (5/7 Days) - Best Recommended",
    price: "45,000 LKR",
    duration: "5/7 Days",
    plan: "Platinum",
    visible: true,
  ...
  {
    id: "fb-plt-6",
    title: "50,000 LKR Package (5/7 Days) - Best Recommended",
    price: "50,000 LKR",
    duration: "5/7 Days",
    plan: "Platinum",
    visible: true,
        ...
        <div className="mb-10 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20 backdrop-blur-lg">
          <div className="space-y-4">
            ...
            <p className="max-w-3xl text-base text-slate-200 sm:text-lg">
              ...
              package that fits your goals. The experience is fully responsive and built as a
              standalone page so the homepage remains unchanged.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-[1.25fr_0.75fr]">
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 transition-all duration-200">
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="mt-3 text-sm leading-6 text-slate-300">
                            Perfect for campaigns that need structure, clarity, and measurable
                            growth.
                          </p>
                        </button>
                      );
              ...
              {confirmed && selectedPackage && (
                <div className="mt-6 rounded-3xl border border-blue-500/20 bg-blue-500/10 p-5 text-white">
                  <p className="text-sm uppercase tracking-[0.3em] text-blue-200">
                    Package confirmed
                  </p>
                  <p className="mt-2 text-base text-white/90">
                    Your package selection is ready. Tap the button below to open WhatsApp and send
                    your confirmation.
                  </p>
                  <a
          ...
          <aside className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
            ...
            <p className="mt-3 text-white/90">
              Use the WhatsApp button for quick support and to confirm custom package details.
            </p>
            <a
        ...
        {adminPanelOpen && (
          <section className="mt-10 rounded-3xl border border-blue-400/25 bg-slate-950/40 p-6 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-blue-300">Admin only</p>
                <h2 className="mt-2 text-2xl font-semibold text-white">
                  Hidden Package Management
                </h2>
              </div>
              <span className="rounded-full bg-blue-500/10 px-3 py-1 text-xs uppercase tracking-[0.25em] text-blue-300">
                Secret panel active
              </span>
            </div>
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
              <div className="space-y-4 rounded-3xl border border-white/10 bg-white/5 p-5">
                <p className="text-sm text-slate-300">
                  Create a new custom package and choose which plan it belongs to.
                </p>
                <div className="grid gap-4 sm:grid-cols-2">
                  <label className="space-y-2 text-sm text-slate-200">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setNewPackage((prev) => ({ ...prev, title: event.target.value }))
                      }
                  ...
                  <label className="space-y-2 text-sm text-slate-200">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setNewPackage((prev) => ({ ...prev, duration: event.target.value }))
                      }
                      className="w-full rounded-2xl border border-white/10 bg-slate-900/80 p-3 text-sm text-white outline-none transition focus:border-sky-300"
                    />
                  </label>
                  <label className="space-y-2 text-sm text-slate-200">
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setNewPackage((prev) => ({ ...prev, plan: event.target.value }))
                      }
                      className="w-full rounded-2xl border border-white/10 bg-slate-900/80 p-3 text-sm text-white outline-none transition focus:border-sky-300"
                    >
                      {plans.map((plan) => (
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <label className="inline-flex items-center gap-3 text-sm text-slate-200">
                    <input
                      ...
                      onChange={(event) =>
                        setNewPackage((prev) => ({ ...prev, visible: event.target.checked }))
                      }
                      className="h-5 w-5 rounded border-white/20 bg-slate-800 text-blue-400 focus:ring-blue-400"
                    />
                    Visible in final package list
                  </label>
                  <Button
                    className="w-full bg-blue-500 text-slate-950 hover:bg-blue-400 sm:w-auto"
                      ...
                      >
                        ...
                        <div className="mt-4 grid gap-3 sm:grid-cols-3">
                          <input
                            ...
                            value={item.title}
                            onChange={(event) =>
                              handlePackageChange(item.id, "title", event.target.value)
                            }
                          ...
                          <input
                            ...
                            value={item.price}
                            onChange={(event) =>
                              handlePackageChange(item.id, "price", event.target.value)
                            }
                            className="w-full rounded-2xl border border-white/10 bg-slate-900/80 p-3 text-sm text-white outline-none focus:border-sky-300"
                            placeholder="Price"
                          />
                          <input
                            ...
                            value={item.duration}
                            onChange={(event) =>
                              handlePackageChange(item.id, "duration", event.target.value)
                            }
                            className="w-full rounded-2xl border border-white/10 bg-slate-900/80 p-3 text-sm text-white outline-none focus:border-sky-300"
                        ...
                        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          <label className="inline-flex items-center gap-3 text-sm text-slate-200">
                            <input
                              ...
                              onChange={(event) =>
                                handlePackageChange(item.id, "visible", event.target.checked)
                              }
                              className="h-5 w-5 rounded border-white/20 bg-slate-800 text-blue-400 focus:ring-blue-400"
                            />
                          ...
                          <select
                            value={item.plan}
                            onChange={(event) =>
                              handlePackageChange(item.id, "plan", event.target.value)
                            }
